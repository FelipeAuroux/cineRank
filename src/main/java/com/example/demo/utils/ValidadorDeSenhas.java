...
public class ValidadorDeSenhas {
    ...
    public static void isStrong(String password) {
        ...
        if (!(countLetter >= 2 && countSpecialCharacters >= 2 && countNumbers >= 2)) {
            throw new RegrasDeNegocioException("A senha está fraca, informe pelo menos 6 dígitos contendo pelo menos duas letras, dois números e dois caracteres especiais!");
        }
